    ...
    return (
        <AnimatePresence>
            {!done && (
                <motion.div
                    key="loader"
                    // Increase z-index to ensure it covers production-optimized elements
                ...
                >
                    {/* --- ALL YOUR UI CODE REMAINS UNTOUCHED --- */}
                    <motion.div
                    ...
                    {[...Array(6)].map((_, i) => (
                        <motion.div
                            key={i}
                            className="absolute w-2 h-2 rounded-full bg-neutral-400/30 dark:bg-neutral-600/30"
                            style={{
                                left: `${20 + i * 12}%`,
                                top: `${20 + (i % 3) * 20}%`,
                            }}
                    ...
                    >
                        <motion.div
                            className="absolute w-44 h-44 rounded-full blur-[40px] bg-neutral-400/30 dark:bg-neutral-600/30"
                            animate={{
                                scale: [1, 1.25, 1],
                        ...
                        <motion.div
                            className="h-1 w-32 rounded-full mt-5 bg-neutral-500/25 dark:bg-neutral-700/25 blur-[3px]"
                            animate={{
                                scaleX: [1, 1.25, 1],
                                opacity: [0.4, 0.8, 0.4],
                            }}
