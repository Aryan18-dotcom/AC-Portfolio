...
export const HeroSection = () => {
  return (
    <div className="mx-auto px-4 min-h-screen py-14">
      ...
      <div className="relative inline-block">
        <Image
          ...
          height={120}
          width={120}
          className="size-32 rounded-full dark:bg-neutral-700 bg-neutral-300"
        />
      </div>
      ...
      <div className="container mx-auto mt-8">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-x-1.5 gap-y-2 text-base md:text-lg text-neutral-500 whitespace-pre-wrap">
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="inline-flex items-center text-sm bg-black/5 dark:bg-white/15 border border-dashed dark:border-white/30 border-black/20 py-1 px-2 rounded-md skill-inner-shadow text-black dark:text-white"
          >
          ...
          >
            ...
            <p className="ml-1 text-sm font-bold">Django</p>
          </a>
